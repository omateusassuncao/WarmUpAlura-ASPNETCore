...
namespace CasaDoCodigo.Models
{
    ...
    public class Cadastro : BaseModel
    {
        ...
        [MinLength(5, ErrorMessage = "Nome deve ter no mínimo 5 caractéres.")]
        [MaxLength(50, ErrorMessage = "Nome deve ter no máximo 50 caractéres.")]
        ...
        [Required(ErrorMessage = "UF (Estado) é obrigatório.")]
